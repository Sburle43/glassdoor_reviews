...
def navigate_to_reviews():
    ...
    # reviews_cell = browser.find_element(By.XPATH,"//*[id="EmpLinksWrapper"]/div[2]/div/div[1]/a[1]/p")
...
def sign_in():
    ...
    # password_field = browser.find_element(By.XPATH,"//form[input/@name='password']")
